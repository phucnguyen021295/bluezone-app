...
import CheckBox, {CheckBox as CheckBox1} from 'react-native-elements';
      ...
      <ScrollView style={styles.scroll}>
        ...
        <View style={styles.itemContainer}>
          <TextInfo
            ...
            star
          />
          <Text text={gates} style={styles.itemSelect} />
        </View>
        ...
        <View style={styles.itemContainer}>
          <TextInfo
            ...
            star
          />
          <Text text={yearOfBirth} style={styles.itemSelect} />
        </View>
        ...
        <View style={styles.itemContainer}>
          <TextInfo
            ...
            star
          />
          <Text text={gender} style={styles.itemSelect} />
        </View>
        ...
        <View style={styles.itemContainer}>
          <TextInfo
            ...
            star
          />
          <Text text={countries} style={styles.itemSelect} />
        </View>
        ...
        <View style={styles.itemContainer}>
          <TextInfo
            ...
            star
          />
          <Text text={otherVehicles} style={styles.itemSelect} />
        </View>
        ...
        <View style={styles.itemContainer}>
          <TextInfo
            ...
            star
          />
          <Text text={startDateString} style={styles.itemSelect} />
        </View>
        ...
        <View style={styles.itemContainer}>
          <TextInfo
            ...
            star
          />
          <Text text={endDateString} style={styles.itemSelect} />
        </View>
        ...
        <View>
          ...
          <View style={styles.item2Container}>
            <TextInfo
              ...
              star
            />
            <Text text={startCountryID} style={styles.itemSelect} />
          </View>
          <View style={styles.item2Container}>
            <TextInfo
              styleContainer={styles.headerTwoContainer}
              ...
              star
            />
            <Text text={startProvinceID} style={styles.itemSelect} />
          </View>
        </View>
        ...
        <View>
          ...
          <View style={styles.item2Container}>
            <TextInfo
              ...
              star
            />
            <Text text={endProvinceID} style={styles.itemSelect} />
          </View>
          <FormInput
        ...
        <View>
          ...
          <View style={styles.item2Container}>
            <TextInfo
              ...
              star
            />
            <Text text={afterQuarantine_ProvinceID} style={styles.itemSelect} />
          </View>
          ...
          <View style={styles.item2Container}>
            <TextInfo
              ...
              star
            />
            <Text text={afterQuarantine_DistrictID} style={styles.itemSelect} />
          </View>
          ...
          <View style={styles.item2Container}>
            <TextInfo
              ...
              star
            />
            <Text text={afterQuarantine_WardID} style={styles.itemSelect} />
          </View>
        ...
        <View>
          ...
          <View style={styles.item2Container}>
            <TextInfo
              ...
              star
            />
            <Text text={vn_ProvinceID} style={styles.itemSelect} />
          </View>
          ...
          <View style={styles.item2Container}>
            <TextInfo
              ...
              star
            />
            <Text text={vn_WardID} style={styles.itemSelect} />
          </View>
            ...
            {symptomData.map((symptomItem, index) => (
              <View
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={1}
                  disabled
                  onPress={() => this.onSelectSymptom(symptomItem.id, true)}>
                  <RadioButton
                    disabled
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={1}
                  disabled
                  onPress={() => this.onSelectSymptom(symptomItem.id, false)}>
                  <RadioButton
                    disabled
